...
GO
/****** Object:  Table [dbo].[MovimientoDeComprobantes]    Script Date: 08/11/2023 22:10:10 ******/
...
GO
/****** Object:  Table [dbo].[FormasDePagos]    Script Date: 08/11/2023 22:10:10 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[FormasDePagos]') AND type in (N'U'))
DROP TABLE [dbo].[FormasDePagos]
GO
/****** Object:  Table [dbo].[Comprobante]    Script Date: 08/11/2023 22:10:10 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Comprobante]') AND type in (N'U'))
DROP TABLE [dbo].[Comprobante]
GO
/****** Object:  View [dbo].[vwVenta]    Script Date: 08/11/2023 22:10:10 ******/
DROP VIEW [dbo].[vwVenta]
GO
/****** Object:  Table [dbo].[Venta]    Script Date: 08/11/2023 22:10:10 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Venta]') AND type in (N'U'))
DROP TABLE [dbo].[Venta]
GO
/****** Object:  View [dbo].[vwProductoVendido]    Script Date: 08/11/2023 22:10:10 ******/
DROP VIEW [dbo].[vwProductoVendido]
GO
/****** Object:  Table [dbo].[ProductoVendido]    Script Date: 08/11/2023 22:10:10 ******/
...
GO
/****** Object:  View [dbo].[vwProducto]    Script Date: 08/11/2023 22:10:10 ******/
DROP VIEW [dbo].[vwProducto]
GO
/****** Object:  Table [dbo].[Producto]    Script Date: 08/11/2023 22:10:10 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Producto]') AND type in (N'U'))
DROP TABLE [dbo].[Producto]
GO
/****** Object:  View [dbo].[vwProveedor]    Script Date: 08/11/2023 22:10:10 ******/
DROP VIEW [dbo].[vwProveedor]
GO
/****** Object:  Table [dbo].[Proveedor]    Script Date: 08/11/2023 22:10:10 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proveedor]') AND type in (N'U'))
DROP TABLE [dbo].[Proveedor]
GO
/****** Object:  View [dbo].[vwCliente]    Script Date: 08/11/2023 22:10:10 ******/
DROP VIEW [dbo].[vwCliente]
GO
/****** Object:  Table [dbo].[Cliente]    Script Date: 08/11/2023 22:10:10 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Cliente]') AND type in (N'U'))
DROP TABLE [dbo].[Cliente]
GO
/****** Object:  View [dbo].[vwUsuario]    Script Date: 08/11/2023 22:10:10 ******/
DROP VIEW [dbo].[vwUsuario]
GO
/****** Object:  Table [dbo].[Usuario]    Script Date: 08/11/2023 22:10:10 ******/
...
CREATE TABLE [dbo].[FormasDePagos](
 ...
 CONSTRAINT [PK_FormasDePagos] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
GO
INSERT [dbo].[Cliente] ([IdCliente], [CUIT], [RazonSocial], [Nombre], [Apellido], [Domicilio], [Localidad], [Provincia], [Telefono], [Estado], [FechaAlta], [FechaBaja], [IdUsuario]) VALUES (5, N'11111111332', N'Panaderia', N'Lucio', N'Rodriguez', N'Belgrano 12', N'Salta', N'Salta', N'25546685455', 1, CAST(N'2023-11-07T21:58:56.153' AS DateTime), NULL, 0)
GO
...
GO
INSERT [dbo].[Proveedor] ([IdProveedor], [RazonSocial], [CUIT], [Domicilio], [Provincia], [Estado], [FechaAlta], [FechaBaja]) VALUES (3, N'kjsjjsjjs', N'3333666548', N'skdjsdkmsdkm', N'smdskada', 1, CAST(N'2023-11-07T22:54:10.357' AS DateTime), NULL)
GO
